/**
 * TOUR_CHIPS — icon + colour config for tour tag pills.
 * Used on tour detail pages (suitability icon strip) and tour cards.
 * Icon paths are Heroicons outline, viewBox 0 0 24 24, stroke-linecap/linejoin set to "round".
 */

export type ChipCfg = { icon: string; iconBg: string; iconColor: string; label?: string };

export const TOUR_CHIPS: Record<string, ChipCfg> = {
  // ── Dietary (green) ──
  'Vegetarian': {
  ...
  'Foodie': {
    icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 00.495-7.468 5.99 5.99 0 00-1.925 3.547 5.975 5.975 0 01-2.133-1A3.75 3.75 0 0012 18z"/>`,
    iconBg: 'bg-orange-100', iconColor: 'text-orange-700',
  },
  // ── Specialties (amber/indigo) ──
  'Heritage': {
  ...
  'Market': {
    icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007z"/>`,
    iconBg: 'bg-amber-100', iconColor: 'text-amber-700',
  },
  // ── Additional tour card chips ──
  'First-Time Visitors': {
    icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456z"/>`,
...
/**
 * Maps raw slug values from Payload (dietaryOptions, travelTypes) to TOUR_CHIPS keys.
 * Used on tour cards to derive icon+label from raw data.
 */
export const TAG_CHIP_MAP: Record<string, string> = {
  // dietaryOptions slugs
  'halal': 'Halal',
  'vegetarian-friendly': 'Vegetarian',
  'vegan-friendly': 'Vegan',
  'gluten-free-friendly': 'Gluten-Free',
  'nut-allergy-friendly': 'Nut-Allergy Friendly',
  // travelTypes slugs
  'couples': 'Couples',
  'solo-travelers': 'Solo Traveler',
  'families': 'Family-Friendly',
  'food-enthusiasts': 'Foodie',
