...
export interface SEOConfig {
  ...
  socialLinks: {
    ...
    youtube?: string;
    twitter?: string;
    tripadvisorKL?: string;
    tripadvisorPenang?: string;
    viator?: string;
    getyourguide?: string;
  };
  businessInfo: {
...
export const seoConfig: SEOConfig = {
  ...
  siteUrl: (typeof process !== 'undefined' && process.env?.PUBLIC_SITE_URL) ? process.env.PUBLIC_SITE_URL.replace(/\/$/, '') : "https://simplyenak.com",
  defaultTitle: "Simply Enak | Malaysian Food Tours in KL & Penang",
  defaultDescription:
    "Simply Enak has been sharing Malaysia's food heritage since 2011. Walking food tours in Kuala Lumpur and Penang, led by locals who grew up eating here.",
...
export function generateLocationSchema(
  ...
  return {
    ...
    description: `${seoConfig.siteName} runs walking food tours in ${locationData.name} led by locals who grew up eating here. Local stalls, real stories, small groups.`,
    address: {
      "@type": "PostalAddress",
