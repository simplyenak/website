...
export interface Config {
  ...
  collections: {
    ...
    cte_posts: CtePost;
    cte_pages: CtePage;
    experience_notes: ExperienceNote;
    exports: Export;
    imports: Import;
  ...
  collectionsSelect: {
    ...
    experience_notes: ExperienceNotesSelect<false> | ExperienceNotesSelect<true>;
...
export interface LandingPage {
  ...
  /**
   * Intro paragraph body for location pages (maps to location-landing-pages.json intro_content)
   */
  intro_content?: string | null;
  /**
   * Heading for travel tips section on location pages (maps to travel_tips_heading)
   */
  tips_heading?: string | null;
  /**
   * Travel tips for location pages (maps to location-landing-pages.json travel_tips)
   */
  travel_tips?:
    | {
        title?: string | null;
    ...
    | null;
  /**
   * Hero hook line under the page title (replaces hardcoded getHook())
   */
  hero_hook?: string | null;
  /**
   * Problem/agitate section title (replaces hardcoded getProblem())
   */
  problem_heading?: string | null;
  /**
   * Problem/agitate section body (replaces hardcoded getProblem())
   */
  problem_content?: string | null;
  /**
   * Main page copy in Markdown. Optional "## People", "## Places", "## Stories" headings render as the three-card layout; everything else renders as prose paragraphs.
   */
...
export interface Story {
  ...
  scheduledPublish?: string | null;
  /**
   * Locations covered in this story (KL, Penang, Ipoh, etc.)
   */
  locationsRef?: (number | Location)[] | null;
  /**
   * 🌐 Per-locale translations keyed by languages_code (e.g. "ms","zh"). Machine-generated by the i18n pipeline; edit here to override. Sync pushes these into the site JSON translations[].
   */
  translations?:
    | {
        [k: string]: unknown;
...
/**
 * 📝 First-hand experience notes from guides — prices, vendors, sensory details, surprises
 *
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "experience_notes".
 */
export interface ExperienceNote {
  id: number;
  /**
   * Brief title for this experience note (e.g., "Pudu Market Morning Visit")
   */
  title: string;
  /**
   * URL-friendly identifier
  ...
  slug: string;
  /**
   * Where this experience happened (e.g., "Pudu Market, KL" or "Jalan Alor, KL")
   */
  location: string;
  /**
   * Which tour this experience relates to (if applicable)
   */
  linkedTour?: (number | null) | TourMaster;
  /**
   * What type of insight this is
   */
  noteType?: ('vendor_discovery' | 'tour_debrief' | 'location_scout' | 'seasonal_update' | 'customer_story') | null;
  /**
   * Food items mentioned with prices and details
   */
  dishes?:
    | {
        /**
         * Dish name (e.g., "char kway teow")
         */
        name: string;
        /**
         * Price in RM (e.g., "RM 8")
         */
        price?: string | null;
        /**
         * Where to get it (e.g., "Jalan Alor stall near 7-Eleven")
         */
        vendor?: string | null;
        /**
         * What makes it special, how to order, tips
         */
        notes?: string | null;
        id?: string | null;
      }[]
    | null;
  /**
   * Vendors/stalls/restaurants with insights
   */
  vendors?:
    | {
        name: string;
        type?: ('street_stall' | 'hawker_stall' | 'food_court' | 'restaurant' | 'market_stall' | 'kopitiam') | null;
        /**
         * Street address or landmark
         */
        address?: string | null;
        /**
         * Owner/chef name (if known)
         */
        ownerName?: string | null;
        /**
         * How long they have been operating
         */
        yearsRunning?: string | null;
        /**
         * What they are known for
         */
        signatureDish?: string | null;
        /**
         * Background, family story, interesting facts
         */
        story?: string | null;
        /**
         * Tips for visitors (best time, what to order, payment)
         */
        tips?: string | null;
        id?: string | null;
      }[]
    | null;
  /**
   * Sensory observations (texture, taste, smell, sound)
   */
  sensoryDetails?:
    | {
        /**
         * e.g., "crispy outside, soft inside", "smoky from charcoal"
         */
        detail: string;
        category?: ('texture' | 'taste' | 'smell' | 'sound' | 'visual' | 'temperature') | null;
        id?: string | null;
      }[]
    | null;
  /**
   * Unexpected things you learned or discovered
   */
  ...
  recommendations?:
    | {
        tip: string;
        priority?: ('must' | 'high' | 'nice') | null;
        id?: string | null;
      }[]
    | null;
  /**
   * Best time to visit (e.g., "Before 8 AM", "5 PM-7 PM")
   */
  bestTime?: string | null;
  /**
   * Price range for the area/food (e.g., "RM 5-15 per dish")
   */
  priceRange?: string | null;
  /**
   * Original voice transcript or quick notes (for reference)
   */
  rawNote?: string | null;
  /**
  ...
  images?:
    ...
    | null;
  /**
   * Existing stories this note should enrich
   */
  linkedContent?: (number | Story)[] | null;
  /**
   * Current status
   */
  status?: ('draft' | 'ready_review' | 'reviewed' | 'used') | null;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface PayloadLockedDocument {
  ...
  document?:
    ...
    | ({
        relationTo: 'experience_notes';
        value: number | ExperienceNote;
      } | null);
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "experience_notes_select".
 */
export interface ExperienceNotesSelect<T extends boolean = true> {
  title?: T;
  slug?: T;
  location?: T;
  linkedTour?: T;
