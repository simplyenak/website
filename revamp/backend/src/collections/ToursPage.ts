...
export const ToursPage: CollectionConfig = {
  ...
  fields: [
    ...
    { name: 'not_sure_cta_href', type: 'text' },
    {
      ...
      type: 'json',
      admin: {
        description: '🌐 Per-locale translations keyed by languages_code (e.g. "ms","zh"). Machine-generated by the i18n pipeline; edit here to override. Sync pushes these into the site JSON translations[].',
      },
    },
  ],
}
