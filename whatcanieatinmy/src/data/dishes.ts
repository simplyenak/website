...
export const dishes: Dish[] = [
  ...
  {
    id: "roti-nasik",
    name: "Roti Telur (Egg Roti Canai)",
    category: "Main",
    origin: "Indian",
    description: "Roti canai with egg folded in, sometimes with onion. Popular morning option.",
    vegetarian: "caution",
    vegan: "avoid",
    halal: "safe",
    glutenFree: "avoid",
...
export const dietaryRestrictions = [
  ...
  { id: "halal", label: "Halal", icon: "🕌", description: "Halal-certified food options" },
