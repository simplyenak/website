    ...
    >
      <div className="grid grid-rows-[auto_0fr] transition-all duration-500 ease-in-out">
        <button
          ...
          className="flex items-center justify-between gap-3 md:gap-5 text-left cursor-pointer font-merriweather p-5 hover:bg-gray-50 transition-colors duration-200"
        >
