...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutHero: Schema.Attribute.Component<'global-hero.global-hero', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    ourCoreValuesSection: Schema.Attribute.Component<
...
export interface ApiCustomToursMainCustomToursMain
  extends Struct.SingleTypeSchema {
  collectionName: 'custom_tours_mains';
  info: {
    displayName: 'Custom Tours Main';
    pluralName: 'custom-tours-mains';
    singularName: 'custom-tours-main';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    navItems: Schema.Attribute.Component<'nav-items.item', true>;
    publishedAt: Schema.Attribute.DateTime;
    sectionName: Schema.Attribute.String &
      Schema.Attribute.Private &
