  ...
  for (const doc of docs) {
    ...
    const flat = {
      ...
      translations: (doc.translations || []).map(t => ({
        languages_code: typeof t.languages_code === 'object' ? t.languages_code.code : t.languages_code,
        meta_title: t.meta_title || '',
        meta_description: t.meta_description || '',
        hero_title: t.hero_title || '',
        hero_subtitle: t.hero_subtitle || '',
        hero_description: t.hero_description || '',
        dietary_name: t.dietary_name || '',
        specialty_name: t.specialty_name || '',
        travel_type_name: t.travel_type_name || '',
        icon: t.icon || '',
        color: t.color || '',
        challenges_heading: t.challenges_heading || '',
        options_heading: t.options_heading || '',
        options_content: t.options_content || '',
        tips_heading: t.tips_heading || '',
        ...
        why_perfect_heading: t.why_perfect_heading || '',
        why_perfect_content: t.why_perfect_content || '',
        expect_heading: t.expect_heading || '',
        expect_content: t.expect_content || '',
      })),
    }
...
async function sync() {
  ...
  function mergeExistingTranslations(newDocs, fileName) {
    const existingPath = path.join(CONTENT_DIR, fileName)
