...
export const states: StateEntry[] = [
  {
    ...
    },
    {
      ...
      origin: "Perlis (native variety)",
      what: "Perlis’ protected fragrant mango, grown almost exclusively in the state and celebrated in Malaysia as the ‘King of Mangoes’. Prized for dense sweet flesh; season runs roughly April to June and queues form at the farms.",
...
export const packages: PackageCard[] = [
  {
    id: 'essentials',
    name: 'Malaysia Food Essentials',
    status: 'free',
    price: 'Free',
    blurb: 'The twelve national classics you will find everywhere. Tick them off and share your score.',
    includes: [
      '12 national dishes with town origins',
      'Halal notes for each dish',
      'Best time of day to eat',
      'Tick, track and share progress',
  ...
  },
  {
    ...
    includes: [
      ...
      'When to go for each area',
      'Penang-exclusive dishes with context',
      'Transit tips: walking, Grab, parking',
    ],
  },
  {
    id: 'city-kl',
    ...
    includes: [
      ...
      'When to go for each area',
      'KL-exclusive dishes with context',
      'Transit tips: LRT, monorail, walking',
    ],
  },
  {
    id: 'city-melaka',
    ...
    includes: [
      ...
      'Nyonya dish origins and variations',
      'Best hours for night market',
  ...
  },
  {
    ...
    includes: [
      ...
      'How to ask at stalls that are not certified',
      'Vegetarian-friendly Malaysian dishes',
  ...
  },
  {
    ...
    includes: [
      ...
      'Buddhist vegetarian restaurants (cha fan)',
      'Mamak stall vegetarian ordering guide',
      'Ingredients to watch for: belacan, stock',
    ],
  },
  {
    id: 'full-collection',
