...
export const packages: PackageCard[] = [
  ...
  },
  {
    ...
    status: 'coming',
    price: 'RM10 one-time',
    blurb: '47 dishes across Malaysia\'s two most-visited cities. Exact stalls, street names, and when to go.',
    includes: [
      '32 Penang dishes with stall addresses',
      '15 KL dishes with neighborhood guides',
  ...
  },
  {
    ...
    status: 'coming',
    price: 'RM25 one-time',
    blurb: 'All fourteen state guides, the Nyonya deep dive, and every diet flag — one purchase, access forever.',
    includes: [
      'All 16 state food guides',
      'Nyonya kitchen deep dive',
      '81-dish master checklist',
      'Complete diet safety flags',
