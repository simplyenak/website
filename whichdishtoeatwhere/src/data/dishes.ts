...
export const states: StateEntry[] = [
  // ── Northern Peninsula ────────────────────────────────────────────────
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        what: 'Fresh sap tapped from nipah palms, served cold; the same sap, left to ferment, becomes tuak. A proper Kuala Perlis stop between laksa and grilled fish.',
    ...
    dishes: [
      {
        ...
        what: 'Rice noodles in a sour tamarind-and-mackerel broth with mint, pineapple and prawn paste. Consistently ranked among the world\u2019s great dishes.',
  ...
  },
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        origin: 'Chinese',
        what: 'Rice-noodle rolls with a sweet dark sauce, fried shallots and sesame; the town\u2019s lean is its own regional classic.',
  ...
  // ── Southern Peninsula ────────────────────────────────────────────────
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        origin: 'Chinese',
        what: 'Springy noodles with braised beef chunks, a dark peanut-chili sauce and broth on the side. A century-old Seremban coffee-shop dish.',
  ...
  },
  {
    ...
    name: 'Johor',
    region: 'south',
    intro: "Malaysia’s deep south runs on Muar: laksa Johor, mee bandung and otak-otak, with Batu Pahat’s rice and JB’s midnight kacang pool.",
    dishes: [
      {
        id: 'laksa-johor',
        name: 'Laksa Johor',
  ...
  },
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        origin: 'Malay',
        what: "Kelantan’s version trades tuna curry for a richer gulai and runs sweeter than its Terengganu cousin.",
  ...
  },
  {
    ...
    dishes: [
      ...
      },
      {
        ...
        name: 'Ikan bakar & satay night market',
        what: 'Grilled fish and skewers at the pasar malam, with duty-free soft drinks nobody admits to buying.',
        where: 'The nightly market strip near the town waterfront.',
        bestTime: 'Evening',
        halal: 'halal',
      },
    ],
    ...
    dishes: [
      {
        ...
        what: "A paste of some twenty spices (no curry powder) into a prawn-chicken broth with vermicelli, prawns, omelette strips and lime. Anthony Bourdain called it breakfast of the gods.",
