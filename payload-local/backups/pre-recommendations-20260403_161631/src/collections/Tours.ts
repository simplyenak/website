...
export const Tours: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      hasMany: true,
      admin: {
        description: 'Select travel types this tour suits (managed in Travel Type Landing Pages)',
      },
    },
    {
      ...
      hasMany: true,
      admin: {
        description: 'Select specialty experiences featured (managed in Specialty Landing Pages)',
      },
    },
    {
      name: 'foodItems',
    ...
    },
    {
      ...
      type: 'text',
      admin: {
        description: 'Main tour image URL',
      },
    },
    {
      name: 'galleryImages',
